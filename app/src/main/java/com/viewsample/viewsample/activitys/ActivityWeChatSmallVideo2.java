...
public class ActivityWeChatSmallVideo2 extends AppCompatActivity {
        ...
        mSurfaceView.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                ...
                if (motionEvent.getAction() == MotionEvent.ACTION_DOWN){
                    ...
                    mPopwindow.setContentView(new FocusingView(ActivityWeChatSmallVideo2.this).setCallBack(new FocusingView.CallBack() {
                        @Override
