...
public class loadMoreView extends RelativeLayout implements OnTouchListener {
...
//		setBackgroundColor(Color.BLACK);
	...
	public loadMoreView setContentView(View ContentView) {
		if (contentView == null) {
...
//		//如果不是顶部则直接返回
//		if (((AbsListView)v).getFirstVisiblePosition() != 0){
//			return  false;
//		}
//
...
//				int moveValue = Math.round(lastY - event.getY())*-1;
//				//保留本次坐标
//				lastY = event.getY();
//
//				//下拉
//				if (moveValue>0) {
//					Log.i("=====",moveValue+"__"+moveValue/(2+10));
//					//增加高度
//					addHeight(moveValue/(2+getHeight()/PULL_VISCOSITY));
//					hasSelect = false;
//				//上拉
//				}else{
//					Log.i("=====",getHeight()+"__"+hasSelect);
//					//如果已经看不到
